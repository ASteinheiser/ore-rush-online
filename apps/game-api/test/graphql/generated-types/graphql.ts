...
export type Test_GetProfileShipsQuery = { profile: { selectedShipId: string | null, ships: Array<{ id: string, shipId: string }> | null } | null };
...
export type Test_SelectShipMutationVariables = Exact<{
  shipId: string;
}>;


export type Test_SelectShipMutation = { selectShip: { selectedShipId: string | null } | null };
