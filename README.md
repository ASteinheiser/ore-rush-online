...
> Try the live demo: https://ore-rush.online/download

> This template is now listed as an official example in the [Colyseus docs](https://docs.colyseus.io/learn/examples/phaser)

> You can also read the Phaser team's [blog post](https://phaser.io/news/2026/06/typescript-online-game-template-phaser-colyseus-react-and-electron-in-one-monorepo) about the template
